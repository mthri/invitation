...
class Zarinpal():
    ...
    def payment_request(self, amount: int, description: str, 
                        email: str = None, mobile: str = None ) -> Tuple[str, int] :
        ...
        if result.Status == 100:
            ...
            return self.WEB_GATE + str(int(result.Authority)), int(result.Authority)
        else:
    ...
    def payment_url(self, authority) -> str:
        return self.WEB_GATE + str(authority)
