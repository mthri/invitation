...
urlpatterns += [
    ...
    path('ajax/contact/add', ajax_views.AddContact.as_view(), name='ajax_contact_add'),
    ...
    path('ajax/invition/get/all', ajax_views.GetInvititon.as_view(), name='ajax_get_invition_all'),
]
